        ...
        <ul class="inline-flex">
            ...
            <li class="cursor-pointer capitalize m-4">
                <button @click="selectedTab='all'"
                    class="w-32 flex text-center px-4 py-2 bg-light-tail-500
                    dark:bg-dark-navy-100 hover:bg-accent text-white
                    rounded-md transition">All</button>
            </li>
            ...
            <li class="cursor-pointer capitalize m-4" x-data="{projectSkill:{{ json_encode($projectSkill) }}}">
                <button @click="selectedTab=projectSkill.id"
                    class="w-32 flex text-center px-4 py-2 bg-light-tail-500 dark:bg-dark-navy-100 hover:bg-accent text-white rounded-md">
                    {{ $projectSkill->name }}
                </button>
            </li>
