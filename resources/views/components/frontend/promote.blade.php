<section class="bg-light-tail-100 dark:bg-dark-navy-500 py-6" >
    <div class="mx-auto max-w-7xl">
        <div class="py-12 px-4 sm:px-6 lg:flex lg:items-center lg:justify-between lg:py-16 lg:px-8">
          <h2 class="text-3xl font-bold tracking-tight text-dark-navy-500 dark:text-dark-navy-500 sm:text-4xl">
            <span class="block">Ready to dive in?</span>
            <span class="block text-indigo-600">Flutter Apps with AI and Machine Learning.</span>
          </h2>
